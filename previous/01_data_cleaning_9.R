...
cat("   1. death_date 빈칸 → 생존 (0)\n")
cat("   2. Lab 변수 결측치 ≥50% → 분석에서 제외\n")
cat("   3. Lab 검사 안함 → -999 표시 (base_ct_lab)\n")
cat("   4. discharge_diagnosis 빈칸 → admission_diagnosis로 채움\n")
cat("   5. discharge_status 빈칸 → 'ER discharge'\n")
cat("   6. discharge_date 빈칸 → visit_date와 동일\n")
cat("   7. 질환 관련 빈칸 → 'None'\n")
cat("   8. 수술 기왕력 빈칸 → 'None'\n")
cat("   9. CT 안함 → ct_any_positive = -1\n\n")
